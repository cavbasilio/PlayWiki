...
<head>
        ...
        <!-- Inclua os links para os estilos do FontAwesome -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"
            integrity="sha384-H4MD6mqIauG+LkQ3I5aFuYPQHY7IxfQ0JMKuAP46PI4lnm+5RF4f0R95uXzWv2v1" crossorigin="anonymous">
        <!-- Adicione o link para os estilos do Bootstrap -->
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
            integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
        <!-- Link para fontes da GOOGLE--> 
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #ffa500;">
        ...
        <!-- Div para agrupar itens do menu -->
